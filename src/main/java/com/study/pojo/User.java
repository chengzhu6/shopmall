...
public class User {
    ...
    public User(Integer id, String username, String password, String email, String phone, String qusetion, String answer, Integer role, Date createTime, Date updateTime) {
        this.id = id;
